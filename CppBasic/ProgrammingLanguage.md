...
`C++`` 프로그래밍 언어는 앞에서 설명한 **절차적 프로그래밍 (procedure programming)**, **객체지향 프로그래밍 (object-orinted programming)**,**일반화 프로그래밍 (generic programming)**의 개념과 기법을 모두 가지고 있다.  
